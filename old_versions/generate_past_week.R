...
cat("â•‘        Seasons:", START_SEASON, "-", CURRENT_SEASON, "| Predicting Week:", PREDICTION_WEEK, "              â•‘\n")
...
cat("â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\n")
cat("â•‘  PHASE 1: DATABASE SETUP & DATA PREPARATION                   â•‘\n")
cat("â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n\n")
...
if (db_is_valid(db_path)) {
  cat("      âœ“ Valid database found at:", db_path, "\n")
} else {
  ...
  cat("      âœ“ Database created successfully!\n")
}
...
# ==============================================================
# NFL Weather & Injuries â€“ Clean and Save Separately
# ==============================================================
...
if (file.exists(weather_file)) {
  ...
  cat("      âœ“ Cleaned weather data saved to nflweather_games_clean.csv\n")
  cat("      Preview (first 3 rows):\n")
  print(head(weather, 3))
} else {
  cat("      âš  Weather file not found:", weather_file, "\n")
  cat("      Skipping weather data cleaning...\n")
}

# -----------------------------
# 2ï¸âƒ£ Clean Injuries Data
# -----------------------------
...
if (file.exists(injuries_file)) {
  ...
  cat("      âœ“ Cleaned injuries data saved to nfl_injuries_clean.csv\n")
  cat("      Preview (first 3 rows):\n")
  print(head(injuries, 3))
} else {
  cat("      âš  Injuries file not found:", injuries_file, "\n")
  cat("      Skipping injuries data cleaning...\n")
}

cat("      âœ“ Weather and injuries cleaning complete\n\n")
...
cat("      âœ“ Filter query prepared (data still in database)\n")
...
cat("      âœ“ Calculated columns added to query\n")
...
cat("      âœ“ Data loaded:", nrow(pbp_analysis), "plays\n")
cat("      âœ“ Seasons:", paste(unique(sort(pbp_analysis$season)), collapse = ", "), "\n")
cat("      âœ“ Date range:", min(pbp_analysis$game_date), "to", max(pbp_analysis$game_date), "\n")
...
cat("â•‘  PHASE 2: CALCULATING ADVANCED METRICS                        â•‘\n")
cat("â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n\n")
...
cat("      âœ“ Pace metrics calculated\n")
...
cat("      âœ“ Offensive stats calculated\n")
...
cat("      âœ“ Defensive stats calculated\n")
...
cat("      âœ“ Rolling averages and trends calculated\n")
...
cat("      âœ“ Schedule loaded:", nrow(schedules), "games for week", PREDICTION_WEEK, "\n")
...
cat("      âœ“ Travel and situational factors calculated\n")
...
cat("      âœ“ Matchup dataset created:", nrow(matchups), "games\n")
...
cat("â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\n")
cat("â•‘  PHASE 3: MATCHUP ANALYSIS & PREDICTIONS                      â•‘\n")
cat("â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n\n")
...
cat("âœ“ Predictions and betting analysis complete\n\n")
...
cat("â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\n")
cat("â•‘  PHASE 4: GENERATING OUTPUTS                                  â•‘\n")
cat("â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n\n")
...
cat("âœ“ Excel file saved:", output_file, "\n\n")
...
cat("âœ“ CSV files exported to:", matchup_dir, "\n")
...
cat("â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\n")
cat("â•‘                    WEEK", PREDICTION_WEEK, "PREDICTIONS SUMMARY                    â•‘\n")
cat("â•‘                    Based on 2021-2025 Data                     â•‘\n")
cat("â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n\n")
